...
Je suis un développeur passionné qui a récemment effectué une transition de carrière vers le domaine du développement web. Ayant suivi avec succès une formation à The Hacking Project et une formation de développeur WordPress chez OpenClassrooms, j'ai acquis une solide expertise dans le développement front-end, ainsi que des compétences complémentaires en PHP, SCSS, JavaScript et l'intégration de maquettes Figma.
...
Actuellement, je suis animé par une nouvelle passion : la cybersécurité et l'administration des systèmes et réseaux. Convaincu que ma solide base en développement, associée à ma détermination à réussir dans ce nouveau domaine, feront de moi un atout précieux pour toute équipe, je suis enthousiaste à l'idée de contribuer à des projets stimulants et de continuer à apprendre dans ce domaine en constante évolution.
